...
import { ArrowLeft, NotebookPen, CheckCircle, X } from "lucide-react";
...
export default function GeradorAta() {
  ...
  const handleSubmit = async () => {
    ...
    const systemPrompt = "Você é um especialista em documentação empresarial. Transforme as anotações fornecidas em uma ata de reunião profissional e organizada. Extraia participantes, tópicos, decisões e responsáveis. Use APENAS tópicos com \"-\" e **negrito**. NUNCA use \"---\" ou \"////\" ou \"===\" ou \"***\". Responda em português brasileiro.";
  ...
  return (
    <div className="tool-container pt-24">
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="font-title font-semibold text-3xl">Gerador de Ata de Reunião</h1>
      </div>
      <p className="text-light/60 mb-8">Faça upload de um arquivo ou cole suas anotações da reunião para gerar uma ata profissional organizada.</p>
